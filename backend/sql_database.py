...
class SQLDatabase:
    ...
    def __init__(self, database_path: str = None):
        ...
        if database_path is None:
            database_path = os.path.join(os.path.dirname(__file__), "..", "db", "sports_stats.db")
    ...
    def bulk_insert_dataframe(self, table_name: str, df: pd.DataFrame, if_exists: str = 'append'):
        """
