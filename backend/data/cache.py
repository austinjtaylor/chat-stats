...
def get_cache() -> CacheManager:
    ...
    if _cache_instance is None:
        ...
        _cache_instance = CacheManager(default_ttl=config.CACHE_TTL, max_size=1000)
...
def cache_key_for_query(query: str, params: Optional[dict] = None) -> dict:
    ...
    """
    return {"type": "query", "query": query.strip().lower(), "params": params or {}}
...
def cache_key_for_endpoint(endpoint: str, **kwargs) -> dict:
    ...
    Returns:
        Dict suitable for cache key
    """
    return {"type": "endpoint", "endpoint": endpoint, **kwargs}
