...
class TestUFAAPIClient:
    ...
    def test_init_custom_url(self):
        ...
        assert client.base_url == "https://custom-api.com/v2"  # Should strip trailing slash
...
class TestUFAAPIClientGames:
    ...
    def test_get_games_default_current_year(self, mock_datetime, api_client_with_mock_request):
...
class TestUFADataManager:
    ...
    def data_manager(self):
        ...
        with patch('ufa_data_manager.UFAAPIClient') as mock_client_class, \
...
class TestImportHelpers:
    ...
    def test_clear_database(self, data_manager):
        ...
        delete_calls = [call for call in data_manager._mock_db.execute_query.call_args_list 
...
class TestMainFunction:
    ...
    def test_main_import_api_no_years(self, mock_manager_class):
        ...
        mock_manager = Mock()
        mock_manager.import_from_api.return_value = {"teams": 5, "players": 100, "games": 50}
    ...
    def test_main_import_api_with_years(self, mock_manager_class):
        ...
        mock_manager = Mock()
        mock_manager.import_from_api.return_value = {"teams": 2, "players": 50, "games": 25}
        mock_manager_class.return_value = mock_manager
...
class TestIntegration:
    ...
    def test_error_recovery(self, data_manager):
        ...
        data_manager._mock_api_client.get_teams.side_effect = Exception("Teams API failed")
        data_manager._mock_api_client.get_players.return_value = []
        data_manager._mock_api_client.get_games.return_value = []
