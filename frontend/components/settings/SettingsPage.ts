        ...
        <div class="settings-card">
          ...
          <div class="theme-options">
            <button class="theme-option ${savedTheme === 'light' ? 'active' : ''}" data-theme="light">
              <img src="/images/themes/light_theme.png" alt="Light theme preview" class="theme-option-preview">
              <span class="theme-option-title">Light</span>
            </button>
            <button class="theme-option ${savedTheme === 'dark' ? 'active' : ''}" data-theme="dark">
              <img src="/images/themes/dark_theme.png" alt="Dark theme preview" class="theme-option-preview">
