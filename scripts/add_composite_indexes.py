...
def add_composite_indexes():
    ...
    if not database_url:
        ...
        print("   Please set DATABASE_URL in your .env file to point to your Supabase database")
        return
    ...
    with engine.connect() as conn:
        for idx, index_sql in enumerate(indexes, 1):
            ...
            try:
                print(f"  [{idx}/{len(indexes)}] Creating {idx_name} on {table_name}...", end=" ", flush=True)
