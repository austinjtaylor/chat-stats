...
class DatabaseSetup:
    ...
    def _generate_players(self, teams_data):
        ...
        first_names = ["Alex", "Jordan", "Taylor", "Sam", "Casey", "Morgan", "Avery", "Riley", "Blake", "Drew"]
    ...
    def _generate_player_stats(self, players_data, games_data):
        ...
        for game in games_data:
            ...
            home_players = [p for p in players_data if p["team_id"] == game["home_team_id"]]
            away_players = [p for p in players_data if p["team_id"] == game["away_team_id"]]
            ...
            for team_players in [home_players, away_players]:
                ...
                playing_players = random.sample(team_players, min(playing_count, len(team_players)))
    ...
    def get_database_info(self):
        ...
        tables = ["teams", "players", "games", "player_game_stats", "player_season_stats", "team_season_stats"]
        for table in tables:
            try:
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python database_setup.py init          # Initialize database with schema")
